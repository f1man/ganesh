...
const content = {
  ja: {
    ...
    heroTitle1: "もし、叶えたかった願いや諦めていたことを",
    heroTitle2: "諦めている理由が「体の不安」なら。",
    heroSub: "私たちは、それを“叶えるためのプラン”に変えます。",
    ...
    trustTitle: "あなたの心に寄り添い<br>全力でサポートします",
    trust1Title: "看護師の専門知識",
    trust1Desc: "急な体調変化にも落ち着いて対応",
    trust2Title: "オーダーメイドの計画",
    trust2Desc: "あなただけの「叶えたい」を形に",
    trust3Title: "ご家族との連携",
    trust3Desc: "離れているご家族にも安心をお届け",
    trust4Title: "外出のトータルケア",
    trust4Desc: "体調に合わせた無理のないスケジュール管理",
  ...
  ko: {
    heroTag: "PREMIUM MEDICAL CONCIERGE",
    heroTitle1: "만약 간절했던 소원이나 포기했던 일들을",
    heroTitle2: "포기하는 이유가 '건강의 불안'이라면.",
    heroSub: "우리는 그것을 '이루기 위한 플랜'으로 바꿉니다.",
    ...
    trustLabel: "WHY CHOOSE US",
    trustTitle: "당신의 마음을 깊이 헤아리며<br>전력을 다해 서포트합니다",
    trust1Title: "간호사의 전문 지식",
    trust1Desc: "갑작스러운 컨디션 변화에도 침착하게 대응",
    trust2Title: "오더메이드 플랜",
    trust2Desc: "당신만의 '이루고 싶은 꿈'을 현실로",
    trust3Title: "가족과의 연계",
    trust3Desc: "멀리 떨어져 있는 가족에게도 안심을",
    trust4Title: "외출 토탈 케어",
    trust4Desc: "컨디션에 맞춘 무리 없는 스케줄 관리",
